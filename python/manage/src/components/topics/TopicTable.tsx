                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-white">
                  {editingId === topic.id ? (
                    <input
                      ...
                      className="w-full bg-gray-700 text-white rounded border-gray-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                    />
                  ) : topic.name}
                </td>
            ...
            {editingId === topic.id ? (
              <>
                <input
                  ...
                  value={editForm?.name}
                  onChange={e => setEditForm(prev => ({ ...prev!, name: e.target.value }))}
                  className="w-full bg-gray-700 text-white rounded border-gray-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 mb-2"
                  placeholder="Name"
                />
                <input
                  type="text"
              ...
              <>
                ...
                <p className="text-gray-400 text-sm font-mono">{topic.address}</p>
              </>
            )}
