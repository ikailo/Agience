...
{
    public class AgienceDataAdapter : IAgienceDataAdapter, SDK.Models.Entities.IAuthorityDataAdapter
    {
        ...
        public async Task<IEnumerable<T>> GetRecordsAsPersonAsync<T>(string personId, bool includePublic = false) where T : SDK.Models.Entities.AgienceEntity
        {
            ...
            else if (typeof(T) == typeof(Host))
            {
                if (includePublic)
                {
                    return await _context.Set<Host>().Where(h => h.Visibility == SDK.Models.Entities.Visibility.Public || h.OperatorId == personId).ToListAsync() as IEnumerable<T> ?? [];
                }
                else
                {
        ...
        public async Task<T?> GetRecordByIdAsPersonAsync<T>(string recordId, string personId) where T : SDK.Models.Entities.AgienceEntity
        {
        ...
        public async Task<T?> CreateRecordAsPersonAsync<T>(T record, string parentId, string personId) where T : SDK.Models.Entities.AgienceEntity
        {
            if (record == null)
            {
        ...
        public async Task<T?> CreateRecordAsPersonAsync<T>(T record, string personId) where T : SDK.Models.Entities.AgienceEntity
        {
            if (record == null)
            {
                throw new InvalidOperationException("record is null");
            ...
            else if (record is AgentConnection agentConnection)
            {
                ...
                var pluginConnection = await _context.PluginConnections.FirstOrDefaultAsync(pc => pc.Id == agentConnection.PluginConnectionId && (pc.Plugin.CreatorId == personId || pc.Plugin.Visibility == SDK.Models.Entities.Visibility.Public));
        ...
        public async Task UpdateRecordAsPersonAsync<T>(T newRecord, string personId) where T : SDK.Models.Entities.AgienceEntity
        {
            if (newRecord == null)
            {
                throw new InvalidOperationException("record is null");
        ...
        public async Task DeleteRecordAsPersonAsync<T>(string recordId, string personId) where T : SDK.Models.Entities.AgienceEntity
        {
            if (string.IsNullOrWhiteSpace(recordId))
            {
                throw new InvalidOperationException("recordId is invalid");
        ...
        public async Task<IEnumerable<Plugin>> FindPluginsAsPersonAsync(string searchTerm, bool includePublic, string personId)
        {
            ...
            var queryResults = await trigramQuery
                //await fullTextQuery
                //.Union(trigramQuery)                
                //.Where(p => p.CreatorId == personId || (includePublic && p.Visibility == SDK.Models.Entities.Visibility.Public))
        ...
        public async Task AddPluginToHostAsPersonAsync(string hostId, string pluginId, string personId)
        {
            ...
            var plugin = await _context.Plugins
                .FirstOrDefaultAsync(p => p.Id == pluginId && (p.CreatorId == personId || p.Visibility == SDK.Models.Entities.Visibility.Public));
        ...
        public async Task<T?> GetRecordByIdAsync<T>(string recordId) where T : SDK.Models.Entities.AgienceEntity
        {
        ...
        public async Task<T?> CreateRecordAsync<T>(T record) where T : SDK.Models.Entities.AgienceEntity
        {
            if (!string.IsNullOrWhiteSpace(record.Id))
            {
                throw new InvalidOperationException("recordId is invalid");
        ...
        public async Task UpdateRecordAsync<T>(T record) where T : SDK.Models.Entities.AgienceEntity
        {
            if (string.IsNullOrWhiteSpace(record.Id))
            {
                throw new InvalidOperationException("recordId is invalid");
        ...
        public async Task<Person?> GetPersonByExternalProviderIdAsync(string providerId, string providerPersonId)
        {
            return await _context.People.FirstOrDefaultAsync(p => p.ProviderId == providerId && p.ProviderPersonId == providerPersonId);
        }
        ...
        public async Task<SDK.Models.Entities.Host> GetHostByIdNoTrackingAsync(string hostId)
        {
            var host = await _context.Hosts.AsNoTracking().FirstOrDefaultAsync(h => h.Id == hostId);
            return _mapper.Map<SDK.Models.Entities.Host>(host);
        }

        public async Task<IEnumerable<SDK.Models.Entities.Plugin>> GetPluginsForHostIdNoTrackingAsync(string hostId)
        {
            ...
            return _mapper.Map<IEnumerable<SDK.Models.Entities.Plugin>>(plugins);
        }

        public async Task<IEnumerable<SDK.Models.Entities.Agent>> GetAgentsForHostIdNoTrackingAsync(string hostId)
        {
            ...
            return _mapper.Map<IEnumerable<SDK.Models.Entities.Agent>>(agents);
        }
        ...
        public async Task UpsertAgentConnectionAsPersonAsync(string agentId, string pluginConnectionId, string? authorizerId, string? credentialId, string personId)
        {
            ...
            var pluginConnection = await _context.PluginConnections.FirstOrDefaultAsync(pc => pc.Id == pluginConnectionId && (pc.Plugin.CreatorId == personId || pc.Plugin.Visibility == SDK.Models.Entities.Visibility.Public));
