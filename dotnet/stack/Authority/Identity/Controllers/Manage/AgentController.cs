...
namespace Agience.Authority.Identity.Controllers.Manage
{
    ...
    {
        private readonly SDK.Authority _authority;
        private readonly AppConfig _appConfig;
        private readonly IMapper _mapper;
        private readonly StateValidator _stateValidator;

        public AgentController(SDK.Authority authority, AppConfig appconfig, IAgienceDataAdapter dataAdapter, StateValidator stateValidator, ILogger<AgentController> logger, IMapper mapper)
            ...
            return await HandlePost(async () =>
                {
                    ...
                    await _authority.AgentCreated(_mapper.Map<SDK.Models.Entities.Agent>(createdAgent));
        ...
        public async Task<IActionResult> PutAgent([FromBody] Agent agent)
        {
            return await HandlePut(async () =>
            {
                ...
                await _authority.AgentUpdated(_mapper.Map<SDK.Models.Entities.Agent>(updatedAgent));
            });
        }
        ...
        public async Task<IActionResult> DeleteAgent(string id)
        {
            return await HandleDelete(async () =>
            {
                ...
                await _authority.AgentDeleted(new SDK.Models.Entities.Agent() {Id = id });
            });
        }
