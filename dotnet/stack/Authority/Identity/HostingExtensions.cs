...
internal static class HostingExtensions
{
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<IAgienceDataAdapter, AgienceDataAdapter>();
        builder.Services.AddScoped<IAuthorityDataAdapter, AgienceDataAdapter>();


        builder.Services.AddSingleton<IUserStore<Models.Person>>(serviceProvider =>
        {
            var dataAdapter = serviceProvider.GetRequiredService<IAgienceDataAdapter>();
            return new AgiencePersonStore(dataAdapter);
        });
