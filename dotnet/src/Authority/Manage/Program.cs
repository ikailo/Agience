    ...
    internal class Program
    {
        private static async Task Main(string[] args) // Change return type to Task
        {
            ...
            builder.Services.AddTransient(sp =>
            {
                ...
                var authorityLogger = sp.GetRequiredService<ILogger<AuthorityService>>();
                return new AuthorityService(httpClientFactory, httpContextAccessor, authorityLogger, appConfig);
            });
           ...
           .AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, options =>
           {
            ...
            app.UseMiddleware<SessionHandlerService>(); // Validate session state
