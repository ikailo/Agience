...
{
    public class ScopedCompositeLogger<T> : AgienceScopedCompositeLoggerBase, ILogger<T>
    {
        public ScopedCompositeLogger(List<ILogger> loggers, Dictionary<string, object>? scope = null)
            : base(loggers, scope) { }
    }
